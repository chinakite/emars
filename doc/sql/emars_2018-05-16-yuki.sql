...
# Database: emars
# Generation Time: 2018-05-16 12:26:25 +0000
# ************************************************************
...
VALUES
	...
	(3,'ff',NULL,'ff','ff','1','2018-05-15 04:16:36',NULL,NULL);
...
CREATE TABLE `t_copyright` (
  ...
  `c_type` varchar(20) NOT NULL DEFAULT '',
  ...
  `c_modifytime` datetime DEFAULT NULL,
  `c_operator_name` varchar(20) DEFAULT NULL,
...
INSERT INTO `t_copyright` (`c_id`, `c_code`, `c_type`, `c_granter`, `c_granter_id`, `c_grantee`, `c_grantee_id`, `c_signdate`, `c_operator`, `c_project_code`, `c_creator`, `c_createtime`, `c_modifier`, `c_modifytime`, `c_operator_name`, `c_state`)
VALUES
	(1,'2017-wz-001','wz','上海社会科学院出版社有限公司',44,'悦库时光',43,'2018-04-04',2,'aaa-b-c-d',1,'2018-04-04 14:55:03',1,'2018-04-11 11:14:43',NULL,'1'),
	(5,'2018-sp-001','sp',NULL,43,NULL,43,'2018-05-08',1,'3',1,'2018-05-16 04:42:26',NULL,NULL,NULL,'0'),
	(6,'2018-wz-002','wz',NULL,43,NULL,43,'2018-05-02',1,'44',1,'2018-05-16 04:47:30',NULL,NULL,NULL,'2');
...
VALUES
	...
	(8,'demo_thumb_1.jpg','1',2,'http://emars-dev.oss-cn-hangzhou.aliyuncs.com/20180424/1ce59b47-6a4b-4e1e-bebb-27c5d4302e4f',NULL,1,'2018-04-24 18:05:50',NULL,NULL);
...
CREATE TABLE `t_copyright_product` (
  ...
  `c_modifier` bigint(20) DEFAULT NULL,
  `c_modifytime` datetime DEFAULT NULL,
  `c_proportions` varchar(500) DEFAULT NULL,
...
INSERT INTO `t_copyright_product` (`c_id`, `c_copyright_id`, `c_product_id`, `c_price`, `c_privileges`, `c_grant`, `c_copyright_type`, `c_settlement_type`, `c_begin`, `c_end`, `c_desc`, `c_creator`, `c_createtime`, `c_modifier`, `c_modifytime`, `c_proportions`, `c_radio_trans`)
VALUES
	(1,1,1,'12000','1100','1','1','0','2018-04-01','2018-04-30','',1,'2018-04-04 14:55:03',NULL,NULL,NULL,NULL),
	(2,1,2,'8000','1100','1','1','0','2018-04-01','2018-04-30','',1,'2018-04-11 11:14:43',NULL,NULL,NULL,NULL),
	(3,5,7,'','0010','1','1','0','2018-05-01','2018-05-16','3',1,'2018-05-16 04:42:26',NULL,NULL,'3','1'),
	(4,6,8,'4','0001','1','1','0','2018-05-02','2018-05-12','',1,'2018-05-16 04:47:30',NULL,NULL,'4','1');
...
INSERT INTO `t_make_contract` (`C_ID`, `C_CODE`, `C_TARGET_TYPE`, `C_OWNER`, `C_MAKER`, `C_TOTAL_PRICE`, `C_TOTAL_SECTION`, `C_CREATOR`, `C_CREATETIME`, `C_MODIFIER`, `C_MODIFYTIME`, `C_STATE`)
VALUES
	(12,'M20180427-001','0','北京悦库时光文化传媒有限公司','北京金诺佳音国际文件传媒股份公司',23,34,1,'2018-04-27 17:28:31',NULL,NULL,'2'),
	(20,'M20180501-001','0','北京悦库时光文化传媒有限公司','北京星华秀文化传媒有限公司',444,444,1,'2018-05-01 16:41:31',NULL,NULL,NULL),
	(23,'M20180503-001','0','北京悦库时光文化传媒有限公司','1000',1000,1000,1,'2018-05-03 06:22:12',NULL,NULL,NULL),
	(24,'M20180503-002','1','北京悦库时光文化传媒有限公司','rwerqwe',123423,10000,1,'2018-05-03 07:02:21',NULL,NULL,NULL),
	(25,'M20180503-003','0','北京悦库时光文化传媒有限公司','小小jfhsdfsdhjf',123423,10000,1,'2018-05-03 07:06:48',1,'2018-05-03 07:17:16','1'),
	(28,'M20180503-004','0','北京悦库时光文化传媒有限公司','ewrer小小ee',123423,10000,1,'2018-05-03 07:12:26',1,'2018-05-03 07:16:52','0');
...
VALUES
	...
	(14,24,2,100,100,1,'2018-05-03 07:02:21',NULL,NULL,'周杰伦'),
	(15,25,2,NULL,NULL,1,'2018-05-03 07:06:48',NULL,NULL,''),
	(18,28,2,NULL,NULL,1,'2018-05-03 07:12:26',NULL,NULL,'');
...
VALUES
	...
	(8,7,3,1,'2018-05-16 04:42:26'),
	(9,8,4,1,'2018-05-16 04:47:30');
...
INSERT INTO `t_product_info` (`c_id`, `c_name`, `c_author_id`, `c_wordcount`, `c_subject_id`, `c_publish_state`, `c_isbn`, `c_press`, `c_type`, `c_stockin`, `c_desc`, `c_creator`, `c_createtime`, `c_modifier`, `c_modifytime`, `c_production_state`, `c_section`, `c_sort`)
VALUES
	(1,'女心理师',42,'20',1,'1','978-7-5520-1609-3','上海社会科学院出版社','wz','0','',1,'2018-04-04 14:55:03',NULL,NULL,'4',NULL,NULL),
	(2,'木乃伊',43,'32',1,'1','978-7-550-1609-21','','wz','1',NULL,1,'2018-04-11 11:14:43',1,'2018-04-24 15:15:28','5',NULL,NULL),
	(7,'333',NULL,'',1,'1','3',NULL,'sp','0','3',1,'2018-05-16 04:42:26',NULL,NULL,NULL,3,1),
	(8,'444',NULL,'44',1,'1','44',NULL,'wz','0','',1,'2018-05-16 04:47:30',NULL,NULL,'5',NULL,1);
...
LOCK TABLES `t_reservation_announcer` WRITE;
/*!40000 ALTER TABLE `t_reservation_announcer` DISABLE KEYS */;

INSERT INTO `t_reservation_announcer` (`c_id`, `c_product_id`, `c_announcer_id`)
VALUES
	(7,1,1),
	(8,1,2);

/*!40000 ALTER TABLE `t_reservation_announcer` ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES
	...
	(7,'alion','alion',NULL,'645A578B69FEB4C79AF2FD069F0E94BA',NULL,NULL,NULL,NULL,NULL,'1',NULL,NULL,NULL,NULL);
